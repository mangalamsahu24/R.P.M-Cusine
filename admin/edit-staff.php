...
if (isset($_POST['submit'])) {
	...
	$email = $_POST['email'];
	$sql = mysqli_query($con, "Update `staff` set specilization='$specilization',name='$name',address='$address',salary='$salary',contact='$contact',email='$email' where id='$did'");
	if ($sql) {
										...
										<div class="panel panel-white">
											...
											<div class="panel-body">
												...
												?>
													...
													<p><b>Profile Reg. Date: </b><?php echo htmlentities($data['join']); ?></p>
													<?php if ($data['updationDate']) { ?>
														<p><b>Profile Last Updation Date: </b><?php echo htmlentities($data['updatetime']); ?></p>
													<?php } ?>
													<hr />
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														...
														<div class="form-group">
															...
															<input type="number" name="salary" class="form-control" required="required" value="<?php echo htmlentities($data['salary']); ?>">
														</div>
														...
														<div class="form-group">
															...
															<input type="number" name="contact" class="form-control" required="required" value="<?php echo htmlentities($data['contact']); ?>">
														</div>
