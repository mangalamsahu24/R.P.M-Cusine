									...
									<tbody>
										...
										?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['c_name']; ?></td>
												...
												<td>
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														...
														<a href="unread-queries.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
													</div>
